    ...
    <aside class="sidenav">
      ...
      <nav class="sidenav-nav">
        ...
        <div
            ...
            @click="toggleGroup('learning')"
            :aria-expanded="groups.learning"
        ...
        >
          ...
          <span class="flex-1">Learning</span>
          <svg
        ...
        >
          ...
          <svg v-else-if="it.icon==='beach'" width="18" height="18" xmlns="http://www.w3.org/2000/svg"
            ...
            <path
                d="M3 17.25c2.2 1.6 4.4 1.6 6.6 0 2.2 1.6 4.4 1.6 6.6 0 2.2 1.6 4.4 1.6 6.6 0v1.2c-2.2 1.6-4.4 1.6-6.6 0-2.2 1.6-4.4 1.6-6.6 0v-1.2Z"/>
          </svg>
          ...
          <svg v-else-if="it.icon==='quiz'" width="18" height="18" viewBox="0 0 24 24" fill="none"
               stroke="currentColor">
