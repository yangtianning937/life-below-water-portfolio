<template>
  ...
  <section class="m3" @keyup.left.prevent="prevPage" @keyup.right.prevent="nextPage" tabindex="0">
    ...
    <div v-show="page===1" class="m3__page">
      ...
      <p class="m3__p flex">
        Many animals live here—dolphins, fish, seals, seabirds. People come to swim, sail, and play. The bay matters to
        animals and to us!
        <span class="w-1/2 rounded overflow-hidden">
          <img :src="protectBay" alt=""/>
        </span>
      </p>
